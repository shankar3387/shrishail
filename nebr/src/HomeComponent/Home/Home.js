        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-9 p-0">
              ...
              />
              <div style={{ position: 'absolute', top: '40%', left: '10%', color: 'white', fontSize: '35px' }}>
                Your Tagline Goes here
              </div>
              <p style={{ position: 'absolute', top: '55%', left: '10%', color: '#d4d1bc', fontSize: '10px' }}>
                lorem ipsum is simply dummy text of the printing and type scoring industry
              </p>
            </div>
              ...
              <div className="row">
                <div className="col">
                  <div className="card-home">
                    ...
                    <p style={{ position: 'absolute', top: '40%', left: '30%', color: 'white', fontSize: '15px' }}>
                      Upcoming Pop-Up <br />
                      &nbsp;&nbsp;Shops in your <br />
                      &nbsp;&nbsp;&nbsp; community
                    </p>
                ...
                <div className="col">
                  <div className="card-home">
                    <img src={'images/banner2.png'} alt="true" className="img-fluid" />
                    <p style={{ position: 'absolute', top: '50%', left: '30%', color: 'white', fontSize: '15px' }}>
                      Upcoming Events
                    </p>
                  </div>
                </div>
                  ...
                  <div className="rounded bg-white board">
                    <div className="media idea_media border-bottom p-2">
                      ...
                      <div className="media-body d-flex justify-content-between">
                        <span>
                          <small>
                            <span className="m-0 on_name">
                              <b>
                                Vaibhav Sharma Bought <Link href>Casual Shirt</Link>
                              </b>
                            </span>
                          </small>
                          <br />
                        ...
                        <span>
                          <small className="text-warning">14 aug 2020, 09:00 PM</small>
                        </span>
                      </div>
                    </div>
                    {/* / media */}
                ...
                <div className="col-lg-12">
                  <div className="col-lg-12 bg-white shadow_box rounded">
                      ...
                      <div className="col-lg-8">
                        ...
                        <div className="form-check pt-2">
                          <label className="form-check-label">
                            ...
                            <small>You have a positive attitude towards your work</small>
                          </label>
                        </div>
                        <div className="form-check pt-2">
                          <label className="form-check-label">
                            <input type="radio" className="form-check-input" name="optradio" />
                            <small>The moon in a Cancer will promote a feeling</small>
                          </label>
                        </div>
                        <div className="form-check pt-2">
                          <label className="form-check-label">
                            <input type="radio" className="form-check-input" name="optradio" />
                            <small>They motivated and inspiried you to handle the project.</small>
                          </label>
                        </div>
                        <div className="form-check pt-2">
                          <label className="form-check-label">
                            <input type="radio" className="form-check-input" name="optradio" />
                            <small>You had been struggling withit for quite some</small>
                          </label>
                        </div>
                      </div>
                      <div
                    ...
                    <div className="row py-2 d-flex justify-content-between">
                      <div className="col">
                        <button className="btn btn-default bg-warning text-white mr-3 px-4" type="button">
                          Submit
                        </button>
                      </div>
                        ...
                        <div className="post-review border_bottom py-2">
                          <div className="media_blog idea_media pb-1">
                            ...
                            <div className="media-body">
                              ...
                              <br />
                              <small>
                                Commented on <Link href>Food for better health</Link>
                              </small>
                              <br />
                            </div>
                          </div>
                          ...
                          <div className="media_blog idea_media pb-1">
                            <div className="media-body">
                              <small>Lorem Ipsum has been the indusab</small>
                              <br />
                            </div>
                          </div>
                          {/* / media */}
